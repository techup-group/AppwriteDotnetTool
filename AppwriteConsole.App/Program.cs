...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        Listing listing = FakerFactory.GenerateListing();
        var stringListing = JsonSerializer.Serialize(listing);
        // 2 - Create a new document in the collection
        await appwriteService.CreateDocument(databaseId, "listings", stringListing);
    }
}